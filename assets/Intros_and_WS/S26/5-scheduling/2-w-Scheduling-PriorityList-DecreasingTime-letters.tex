...
%\pagestyle{fancy}
\begin{center}
{\Large  Worksheet Scheduling 1: \\Priority Lists and Decreasing Time Algorithm}
\end{center}
...
\node[vtx, label=above:{\scriptsize $A(10)$}, ] (T1) at (0,0){};
\node[vtx, right =of T1, label=above:{\scriptsize $B(7)$}] (T2) {};
\node[vtx, right =of T2, label=above:{\scriptsize $C(4)$}] (T3) {};
\node[vtx, below = \s cm of T1, label=above:{\scriptsize $D(9)$}] (T4) {};
\node[vtx, right =of T4, label=above left:{\scriptsize $E(5)$}] (T5) {};
\node[vtx, right =of T5, label= right:{\scriptsize $F(4)$}] (T6) {};
\node[vtx, below =\s cm of T4, label=below:{\scriptsize $G(13)$}] (T7) {};
\node[vtx, right =of T7, label=below:{\scriptsize $H(4)$}] (T8) {};
\node[vtx, right =of T8, label=below:{\scriptsize $I(6)$}] (T9) {};
...
\item 
\begin{adjustbox}{valign=t,minipage={.4\textwidth}} Here's the digraph again. Create a schedule using the same priority list \[A, B, C, D, E, F, G, H, I\] assuming you have three processors.
\end{adjustbox}
%
%\begin{center}
\hfill
...
%\item Create a schedule using the same priority list \[A, B, C, D, E, F, G, H, I\] assuming you have three processors.
