...
%\pagestyle{fancy}
\begin{center}
{\Large  Worksheet:  Borda Count \& Copeland's Method	 	}
\end{center}
...
\item In the space above, tally the first choice votes.
...
\vfill
  ...
  \item This sheet has \textbf{four} different voting methods (plurality, IRV, Borda, and Copeland) for determining a winner. Make an argument for why one is the preferred method in this case. (That is, you should pick the method for which you can make a strong argument.)
\vspace{1in}
\end{enumerate}
