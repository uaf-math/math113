...
\rhead{\large\sf\textbf{Plurality, Intro}}
...
Definition: \emph{Majority Winner}
...
\item \textbf{Condorcet Winner}\\
\vspace{1in}

\item Show that Chevak (C) is the Condorcet Winner in the vote tally summarized in part 1d (and copied below).\\
