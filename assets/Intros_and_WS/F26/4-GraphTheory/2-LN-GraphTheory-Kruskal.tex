...
\rhead{\large\sf\textbf{Kruskal's Algorithm}}
...
%====================================================
\begin{center}
{\Large\bfseries Minimum Cost Spanning Tree (Kruskal's Algorithm)}\\[2pt]
...
\node[font=\scriptsize,text=black] at (5.5,0.4) {Total MST weight: \emph{11,411 miles}};
...
\item Definitions
	...
	\vfill
	\item \emph{minimum cost spanning tree} (minimum weight spanning tree)
	\vfill
	\end{enumerate}
\item Example: \\
%\fbox{
...
\emph{input:} a graph, $G$, with costs (or weights) on the edges\\
\emph{output:} a spanning tree, $T$, of minimum cost\\
\emph{Steps:}
\begin{enumerate}
