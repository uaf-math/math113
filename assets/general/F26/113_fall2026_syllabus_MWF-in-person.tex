...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=blue,
    pdftitle={Syllabus for MATH F113X (\S 901, 902) Fall 2026},
    }
...
\usepackage{fancyhdr}
\pagestyle{fancy} 
\lhead{\large\sf\textbf{MATH F113X Math and Society (\S 901, 902, MWF in person)}}
...
\fbox{
\begin{tabular}{lll}
{\emph{Instructors}} &Kevin Meek (\S 901) & Leah Berman (\S 902) \\
& 
\href{mailto:krmeek2@alaska.edu}{\texttt{krmeek2\@@alaska.edu}}& 
\href{mailto:lwberman@alaska.edu}{\texttt{lwberman@alaska\@@alaska.edu}} \cr
\strut & \cr
{\emph{Instructor Office}}& Chapman 301C&Chapman 102 \cr
\strut & \cr
...
{\emph{Course Website}} & \url{https://uaf-math.github.io/math113/} \cr
\strut & \cr
\end{tabular}
}
\strut
...
due on Wednesday at the beginning of class (as shown on the course schedule linked in Canvas/on the course website), turned in on paper.  As with Classroom Activities,
...
Homework problems must be written legibly, be stapled, have your name and the homework assignment number, and not have scritchies on the side. See the \emph{Homework Guidelines} on the Homework page for detailed information about how your homework should be written.  
...
\emph{Quizzes are 15\% of the overall course
grade.}


\heading{Exams}
There are 3 exams, scheduled during Week 4, Week 9, and Week 12. Each exam will be 1 hour and will be taken during our normal class period. These exams are
not cumulative; they will only test the material that has been covered since the previous exam. Non-programmable calculators will be allowed on these exams. Make-up
exams will be given only for documented excused absences. See the schedule for your section to determine the exact dates. If you know you have a conflict with an exam date due to a university-approved absence, please talk to your instructor as soon as possible.

\emph{Each  exam is 20\% of the overall course grade for a total of 60\% of the course grade.}
