...
\begin{enumerate}
	...
	\item Identify the \emph{un-visited} vertex with the smallest distance to $e$. Mark it as current and return to step 2. You know when to stop when vertex $s$ is labeled as \textbf{current}.
\end{enumerate}
