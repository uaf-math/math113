...
\end{tikzpicture}
	\vfill
	\item Give an example of a real-world problem which you would want to find a minimum weight spanning tree. (You would need to state what the vertices, edges, and weights represent and the significance of a minimum weight spanning tree in this context.)
	\vfill
	\end{enumerate}
\newpage
\item 
	\begin{enumerate}
	\item Use Dijkstra's Algorithm to find a  shortest path from vertex $S$ to vertex $C$.\\
...
\node[vtx, fill = gray!30] (S) at (90:2) {C};
\node[vtx] (A) at (135:2) {A};
\node[vtx] (B) at (45:2) {B};
\node[vtx] (D) at (90:0.5){D};
\node[vtx, fill = gray!30] (C) at (15+180:1.5){S};
...
\begin{tabular}{ |c | c |c| c|}
 ...
 &visited&\quad distance to $C$ \quad& vertex\\
 \hline
A&&& \\[12pt]\hline
B&&& \\[12pt]\hline
C&&& \\[12pt]\hline
...
\item State the shortest path from $S$ to $C$ and it's length/weight.
%
 %
...
\vfill
	...
	\vfill
	\item Give an example of a real-world problem which you would want to find the minimum distance from $S.$ (You would need to state what the vertices, edges, and weights represent and what is the significance of the shortest path in this context.)
	\vfill
	\end{enumerate}
\newpage
\item 
...
\end{tikzpicture}
	...
	\vfill
	\item Give an example of a real-world problem which you would want to find an Euler circuit. (You would need to state what the vertices, edges, and weights represent and what is the significance of the shortest path in this context.)
	\vfill
	\end{enumerate}
...
\end{tikzpicture}
	\vfill
	\item Give an example of a real-world problem which you would want to find a minimum weight Hamiltonian circuit. (You would need to state what the vertices, edges, and weights represent and what is the significance of the shortest path in this context.)
	\vfill
	\end{enumerate}
\newpage
