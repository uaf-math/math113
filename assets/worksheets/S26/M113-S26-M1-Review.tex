...
\begin{document}
\begin{center} {\Large{Voting Theory}} \\ \end{center}
...
\begin{center} {\Large{Some Voting Theory Problems}}  \end{center}
...
\begin{center} {\Large{Some Weighted Voting Problems}}  \end{center}
\begin{enumerate}
...
\end{enumerate}
\newpage	
\begin{center} {\Large{Some Fair Division Problems}}  \end{center}
\begin{enumerate}
...
\item Harry Potter (P), Hermione Granger (G), Luna Lovegood (L), and Ronald Weasley (W) are dividing up some loot they found in the dungeons. The loot consists of a velvet cloak, a gold chalice, and a self-cleaning cauldron. They decide to divide the loot using the sealed bid method. The table below shows how many \textbf{gold coins} each person bid for each item.\\



\begin{tabular}{l || c|c|c|c|c}
& Potter&Granger&Lovegood&Weasley\\
\hline \hline
cloak&60&50&100&30\\ \hline
chalice&60&10&0&20\\ \hline
cauldron&0&80&100&30\\ \hline
\end{tabular}
